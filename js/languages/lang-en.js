...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'rebirth-upgrades': [
            ["The Classic Automation", `Unlock the ${toTextStyle('Shark','shark')}, ${toTextStyle('Prestige','prestige')}, and ${toTextStyle('Core','core')} automations permanently, as well as no cost ${toTextStyle('Shark','shark')} and ${toTextStyle('Prestige','prestige')} upgrades.`],
            ["Galactic Cultivation", `Unlock the ${toTextStyle('Evolution','humanoid')} and ${toTextStyle('Singularity','black-hole')} automations permanently. Also start with all rows of the evolution tree unlocked.`],
            ["Hadronic Assembler", `Unlock the ${toTextStyle('Hadron','hadron')}-related automations permanently, and the hadronize researches autobuyer.`],
